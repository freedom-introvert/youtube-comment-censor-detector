...
- **在热门列表中屏蔽**
  ...
  - 回复他人的评论，他人可以收到`XXX 回复了你：“xxx”`的通知。**如果评论被热门屏蔽，他人不会收到该通知**
...
在设置里启用选项`二级评论列表强制最新排序`即可。启用后，将会自动修改获取评论回复的请求体，修改排序方式为为按时间。

但这也有局限性，当评论只有一个回复，且这个回复被热门屏蔽时，压根就没有`x条回复`的按钮了。

可继续启用`搜索并显示被热门屏蔽的二级评论`功能。启用后，根评论下第一次获取二级评论时，将获取所有热门评论ID，后正常翻页，若评论ID在热门列表里不存在，则在例如` X 天前`的时间标签后面标注`（热门屏蔽的）`
...
热门排序算法就是坨💩，排前的都是些无价值的彩虹屁！视频作者看到了还沾沾自喜，殊不知自己做的视频可能是一坨😅……
...
> 当地时间12月6日，马斯克抨击欧盟因X平台透明度问题对其处以1.2亿欧元的罚款（约9.8亿人民币），称将对相关欧盟高级官员采取反击，并暗示欧盟应当被废除。欧盟依据《数字服务法案》（DSA）作出此决定，而美国政府则强烈谴责，称此举是针对美国科技企业的攻击。

在北京时间12月12日，我使用YouTube时发现评论区最底下留了一段文字

> 已选择“最热门”，因此你将看到精选评论

![image-20251212112706088](pictures/image-20251212112706088.png)

然后评论区排序方式也添加了注释，以前是只有“最热门”和“最新”这标题而已
...
![image-20251212112442308](pictures/image-20251212112442308.png)

![旧的评论区排序方式下拉菜单_录屏于2025-06-14](pictures/image-20251212112551616.png)

这些东西，至少在北京时间12月6日之前，我是清晰记得没有看到的。

哦嚯，牢管吓到了是吧，用AI分析了一下，你热门屏蔽的行为可是严重违反DSA的哦！连夜加解释，“这是精选评论，我告诉你了哈，别说我们不透明！”，加点解释能免点法律责任是吧……

说说这所谓的“精选评论”，排前的大多数都是一些毫无价值的夸赞评论，有提出问题与分析的却排后（即使有时候排上的彩虹屁评论还不如这条的点赞多）甚至被热门屏蔽。用所谓正能量内容来冲淡真正该关注的内容，这作风不得不让我想到某国的水军。
