<template>
  <div>
    <el-dialog v-model="dialogVisible" :z-index="3000" title="历史评论列表" width="80%" style="height: 92vh;"
      body-class="dialog-body" align-center>
      ...
      <div class="pagination">
        <el-button v-if="prevTime" @click="loadComments('prev')" :disabled="loadingComments">&lt; {{ prevTime == -1 ? "NOW" : formatTimestamp(prevTime)
        }}</el-button>
